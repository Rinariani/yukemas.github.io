              ...
              <div class="row">
                  <div class="col-lg-12 main-chart">
						...
						<div class="col-sm-4">
							<div class="panel panel-primary">
								<div class="panel-heading">
									<h4><i class="fa fa-search"></i> Cari Pelanggan</h4>
								</div>
								<div class="panel-body">
									<input type="text" id="cari" class="form-control" name="cari" placeholder="Masukan : Kode / Nama Pelanggan  [ENTER]">
								</div>
							</div>
						</div>
						<div class="col-sm-8">
						...
						<div class="col-sm-12">
							<div class="panel panel-primary">
								<div class="panel-heading">
									<h4><i class="fa fa-shopping-cart"></i> ADMIN
										...
										<table class="table table-bordered" id="example1">
											<thead>
												<tr>
													...
													<td style="width:10%;"> Jumlah Orderan</td>
										...
										<table class="table table-stripped">
											...
											if(!empty($_GET['nota'] == 'yes')) {
												...
												if(!empty($bayar))
												{
													...
													if($bayar >= $total)
													{
														...
														echo '<script>alert("Bonus Berhasil Di Input !");</script>';
													}else{
											...
											<form method="POST" action="index.php?page=jual&nota=yes#kasirnya">
												...
												<tr>
													...
													<td><button class="btn btn-success"><i class="fa fa-shopping-cart"></i> Input</button>
