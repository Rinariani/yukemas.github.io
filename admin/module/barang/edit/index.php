							...
							<form action="fungsi/edit/edit.php?barang=edit" method="POST">
								...
								<tr>
									...
									<select name="kategori" class="form-control">
										...
										<option value="#">Pilih Jenis Orderan</option>
								...
								<tr>
									...
									<td><input type="number" class="form-control" value="<?php echo $hasil['jumlah_orderan'];?>" name="jumlah_orderan"></td>
								</tr>
								<tr>
									<td>Tanggal Masuk</td>
									<td><input type="date" class="form-control" value="<?php echo $hasil['merk'];?>" name="merk"></td>
								</tr>
								<tr>
									<td>Tanggal Selesai</td>
									<td><input type="date" class="form-control" value="<?php echo $hasil['harga_beli'];?>" name="beli"></td>
								</tr>
								<tr>
