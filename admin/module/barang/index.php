							...
							<table class="table table-bordered table-striped" id="example1">
								...
								?>
									<tr>
										...
										<td><?php echo $isi['jumlah_orderan'];?></td>
									...
									<div class="modal-body">
										...
										<table class="table table-striped bordered">
											...
											<tr>
												...
												<td><input type="number" placeholder="Jumlah Orderan" required class="form-control"  name="jumlah_orderan"></td>
											</tr>
											<tr>
												<td>Tanggal Masuk</td>
												<td><input type="date" placeholder="" required class="form-control"  name="merk"></td>
											</tr>
											<tr>
												<td>Tanggal Selesai</td>
												<td><input type="date" placeholder="" required class="form-control" name="beli"></td>
											</tr>
											<tr>
												<td>Bonus Karyawan/Pcs</td>
												<td><input type="number" placeholder="Bonus" required class="form-control"  name="jual"></td>
											</tr>
											<tr>
												...
												<td>
													<select name="satuan" class="form-control" required>
														...
														<option value="M Parhan">M Parhan</option>
														<option value="Muhammad Alhuddin">Muhammad Alhuddin</option>
														<option value="Arif Wahyu Pranoto">Arif Wahyu Pranoto</option>
														<option value="Rafiqi Muhammad Al Fathur">Rafiqi Muhammad Al Fathur</option>
													</select>
												</td>
											</tr>
											<tr>
