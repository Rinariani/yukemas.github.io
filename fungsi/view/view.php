	 ...
	 */ 
	 class view {
		...
		function __construct($db){
			...
			function jual(){
				$sql ="SELECT nota.* , barang.id_barang, barang.nama_barang, barang.harga_beli, barang.satuan_barang, member.id_member, kategori.nama_kategori,
			...
			function hari_jual($hari){
				...
				$param = "%{$cek}%";
				$sql ="SELECT nota.* , barang.id_barang, barang.nama_barang, barang.harga_beli, member.id_member, barang.satuan_barang, kategori.nama_kategori,
						member.nm_member from nota 
					   left join barang on barang.id_barang=nota.id_barang 
					   left join kategori on kategori.id_kategori=barang.id_kategori 
			...
			function penjualan(){
				$sql ="SELECT penjualan.* , barang.id_barang, barang.nama_barang, member.id_member, barang.satuan_barang, barang.id_kategori, kategori.nama_kategori,
